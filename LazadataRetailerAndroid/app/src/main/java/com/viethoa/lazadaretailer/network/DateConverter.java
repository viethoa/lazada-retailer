...
public final class DateConverter implements JsonSerializer<Date>, JsonDeserializer<Date> {
    ...
    private static final String STANDARD_FORMAT = "yyyy-MM-dd'T'HH:mm:ssZZ";

    private static final String CUSTOM_FORMAT = "yyyy-MM-dd HH:mm:ss";

    private static final String TIME_ZONE = "UTC";

    public DateConverter() {
        this.iso8601FormatStandard = new SimpleDateFormat(STANDARD_FORMAT, Locale.US);
        this.iso8601FormatCustom = new SimpleDateFormat(CUSTOM_FORMAT, Locale.US);
        this.iso8601FormatCustom.setTimeZone(TimeZone.getTimeZone(TIME_ZONE));
    }
